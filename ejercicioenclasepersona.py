...
# Atributos de clase: aquí van atributos muy genéricos, comunes a todas las personas (por ejemplo, las inherentes a su biología)
    ...
    def tipo_actividad(self, *args):
        return f'Tipo de actividad/es que realiza: {args}' # Aquí no necesito poner print, directamente uso return para función indeterminada args. Más adelante, debo usar print para retornar la función.
   
    def idiomas(self, *args):
        return f'Manejo de idioma/as: {args}'
...
print(persona_1.tipo_actividad('natación', 'esgrima'))
print(persona_1.idiomas('alemán','francés'))
...
print(persona_2.tipo_actividad('basketball', 'tenis, hockey'))
print(persona_2.idiomas('espñol', 'inglés', 'italiano'))
